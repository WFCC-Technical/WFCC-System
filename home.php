...
<body>
    <div class="wrap">
        ...
        <div class="card">
            ...
            <?php if (can_view_projects($user)): ?>
                <a href="projects.php" class="btn" style="background:#fff; color:var(--blue); border:1.5px solid var(--blue); margin-left:8px;">View Projects</a>
            <?php endif; ?>
